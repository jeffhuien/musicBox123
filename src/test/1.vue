<template>
  <div class="flex gap-4 w-2/3 h-2/3 border-2 overflow-hidden">
    <el-button @click="setLoading">Click me to reload</el-button>
    <el-skeleton class="flex gap-4 w-full h-full" :loading="loading" animated :count="3">
      <template #template>
        <div class="w-1/3 h-full flex flex-col">
          <el-skeleton-item variant="image" class="h-1/2" style="height: 50%" />
