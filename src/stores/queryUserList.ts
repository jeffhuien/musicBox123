...
export default defineStore('queryUserList', () => {
  // 定义一个数组来存储搜索历史
  ...
  function getItem(id: string) {
    ...
    let res = userList.value[cur.value].ls.find((i) => i.id == id)
    return res
  }
